function NeuroEcPipeline(outputdir)
...
%below if desired.
%saves choice data from individual subjects as csv in subject folders on monstrum
%optimal set of predictors in the calling of logisticGLMFitAug16 is under debate

%!ls -d /import/monstrum/????/subjects/*/*_*/data/econ/ITC/ITC*.txt > NeuroEcfilenames.txt
%ITC day2 fndm, 183 subjects

%!ls -d /import/monstrum/fndm2_new/subjects/*_*/behavioral/ITC_combined*.txt >> NeuroEcfilenames.txt
%ITC fndm2, 203 subjects

%!ls -d /import/monstrum/grmpy/subjects/*_*/behavioral/neuroec/ITC*.txt >> NeuroEcfilenames.txt
%ITC grmpy, 62 of 63 subj with behavioral folder and 64 total subjects listed in the subjects directory

%!ls -d /import/monstrum2/Users/finkelm/ITC/mack/*.csv >> NeuroEcfilenamestest.txt
%ITC PNC 453 subjects
%ITC AND RISK NEFF 82 subjects

%!ls -d /import/monstrum/????/subjects/*/*_*/data/econ/risk/*.txt  >> NeuroEcfilenames.txt
%RISK day2 fndm, 183 subjects

%!ls -d /import/monstrum/nodra/subjects/*_*/behav*/*neuroec/Risk*.txt >> NeuroEcfilenames.txt
%RISK nodra, 99 of 105 subjects with a behavioral folder and 106 total subjects listed in the subjects directory

%!ls -d /import/monstrum/grmpy/subjects/*_*/behavioral/neuroec/Risk*.txt >> NeuroEcfilenames.txt
%RISK grmpy, 62 of 63 subj with behavioral folder and 64 total subjects listed in the subjects directory

%!ls -d /import/monstrum/????/subjects/*/*_*/data/econ/loss/*.txt >> NeuroEcfilenames.txt
%LOSS day2 fndm 182 subjects

%!ls -d /import/monstrum/nodra/subjects/*_*/behav*/*neuroec/*Loss*.txt >> NeuroEcfilenames.txt
%LOSS nodra, 98 subjects with a behavioral folder and 106 total subjects listed in the subjects directory

%!ls -d /import/monstrum/grmpy/subjects/*_*/behavioral/neuroec/Loss*.txt >> NeuroEcfilenames.txt
%LOSS grmpy, 62 of 63 subj with behavioral folder and 64 total subjects listed in the subjects directory

%ITC 984
%LOSS 342
%RISK 426

%fndm2 did not obtain risk or loss separately

%add directory with called functions to path
funcdir = '/import/monstrum2/Users/finkelm/ITC/mack/';
addpath(funcdir);

%import list of filenames, get types
FileNames = importdata('NeuroEcfilenamestest.txt');
...
for i = 1:length(FileNames)
    ...
    switch FileType(i)
        case 1 %OUT OF SCANNER VERSION DAY2 FNDM
		    ...
		    if sessiondata.bblid==11242;	
		    disp(RISKheader)
		    disp(num2str(riskdata));
		    find(trick==0);
	            end;
                    %BREAK HERE TO TEST DATA
                case 3 % LOSS
 	...
 	case 2 % IN SCANNER VERSION FNDM2 (NODRA)   
        ...
        case 4
            ...
            %get questiondata
            load('/import/monstrum2/Users/finkelm/ITC/mack/itemOrderITC.mat')
            load('/import/monstrum/Users/finkelm/ITC/mack/itemOrderRisk.mat')
...
neuroeccsvwrite(ITCdata', 'ITCData.csv', outputdir);
neuroeccsvwrite(LOSSdata', 'LOSSData.csv', outputdir);
neuroeccsvwrite(RISKdata', 'RISKData.csv', outputdir);
